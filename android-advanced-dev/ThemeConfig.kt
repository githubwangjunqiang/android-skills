 ...
 * 使用前需：
 * 1. 根据项目设计稿调整颜色和字体体系
 * 2. 在 Activity / Fragment 的 setContent 中包裹 AppTheme
 * 3. 本文件已内置 AppTypography，如项目已有 Typography 文件，可按需拆分
 */
 ...
 * 2. 图片在深色模式下可根据视觉效果适当降低亮度
 * 3. 在 Activity / Fragment 的 setContent 中包裹 AppTheme，不要在 Application 中调用
 */
